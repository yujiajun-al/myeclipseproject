				...
				<div class="right_col" role="main">
					<div class="">
						<div class="page-title">
									...
									<table>
										<tr>
											...
											<th>学历: <select name="education">
													<option value="">请选择</option>
													<c:forEach items="${fsList }" var="fl">
														<option value="${fl.id }"
															${fl.id==education?"selected":""}>${fl.name }</option>
													</c:forEach>
											</select>
											</th>
													...
													<tbody>
														<c:forEach items="${teacherList }" var="tl">
															<tr class="even pointer">
																...
																<td class=" ">${tl.birthday }</td>													
																<td class=" ">${tl.education=="1"?"大专":(tl.education=="2"?"本科":(tl.education=="3"?"研究生":"硕士")) }</td>
																<td class="a-right a-right ">${tl.phone }</td>
							...
							<!-- page content2 -->
							<div class="aw" style="display: none;">
								<div class="title_left">
									<h3>User Profile</h3>
								</div>
								...
								<div class="title_right">
									<div
										class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
										<div class="input-group">
											<input type="text" id="aq" name="name" class="form-control"
												placeholder="Search for..."> <span
												class="input-group-btn">
																	...
																	<div class="message_wrapper">
																		...
																		<p class="url">
																			<span class="fs1 text-info" aria-hidden="true"
																				...
																				class="fa fa-paperclip"></i> User Acceptance
																				Test.doc </a>
																		</p>
																	</div></li>
																<li><img
